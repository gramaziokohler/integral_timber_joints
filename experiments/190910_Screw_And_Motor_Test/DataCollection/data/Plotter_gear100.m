...
xlabel ("Voltage [V]")
ylabel ("Force [N]");
legend ("1A","2A","3A","4A","5A","6A", "location", "northwest");
title("Screw Pull Force vs Voltage at different limiting current (Motor 555 1:100)")
grid on
saveas(1,"plot_torque_current_100.jpg")
