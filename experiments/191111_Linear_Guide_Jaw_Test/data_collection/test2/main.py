...
time.sleep(0.1)
print("Enter Current (A)")
param_current_ma = float(sys.stdin.readline(100).rstrip()) * 1000
param_dist_mm = int(74)

# Log Session Settings
LOG_FOLDER_NAME = "data"
LOG_SESSION_FILENAME = "result" + "_ma" + str(int(param_current_ma)) + "_dist" + str(int(param_dist_mm)) + ".csv"
