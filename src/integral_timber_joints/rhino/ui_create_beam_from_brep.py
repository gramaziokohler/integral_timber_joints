...
from integral_timber_joints.rhino.create_beam import create_beam_from_brep
...
def RunCommand( is_interactive ):
    ...
    #user input
    result, objRef = Rhino.Input.RhinoGet.GetOneObject("Select Beam,",False, Rhino.DocObjects.ObjectType.Brep,)
    if not objRef or result!=Rhino.Commands.Result.Success: return result
    brep_ref = objRef.Brep()
    print(brep_ref)
