(define (domain itj_clamp_only)
  ...
  (:action pick_element_from_rack
    ...
    :precondition (and
                    ...
                    (RobotGripperEmpty)
                    ; ! sampled
                    (PickAction ?element ?conf1 ?conf2 ?traj)
                    (AtRack ?element)
                  )
  ...
  (:action place_element_on_structure
    :parameters (?element ?conf1 ?conf2)
    :precondition (and
                    ...
                    ; ! sampled
                    (PlaceAction ?element ?conf1 ?conf2 ?traj)
                    )
  ...
  (:action pick_tool_from_rack
    ...
    :precondition (and
                    ...
                    (AtRack ?tool)
                    ; ! sampled
                    (PickAction ?tool ?conf1 ?conf2 ?traj)
                  )
  ...
  (:action place_clamp_at_joint
    ...
    :precondition (and
                    ...
                    ; ! assembly state precondition
                    ; ! sampled
                    (PlaceAction ?tool ?conf1 ?conf2 ?traj)
                    )
